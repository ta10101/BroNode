...
- A cross-platform desktop app (**BroNode**) for operating Edge Node containers. Source and release process: root `README.md`, `docs/INSTALL_AND_UNINSTALL.md`, `RELEASING.md`.
