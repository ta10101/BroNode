...
**Tags:** push `bronode/v*` (e.g. `bronode/v1.0.0`) to trigger builds for Windows `.exe`, Linux `.tar.gz`, macOS `.zip` and create a **public GitHub Release** (not draft) with those assets plus `INSTALL_AND_UNINSTALL.md` on **the repo you pushed the tag to** — e.g. [ta10101/BroNode/releases](https://github.com/ta10101/BroNode/releases) or, once merged, [Holo-Host/edgenode/releases](https://github.com/Holo-Host/edgenode/releases).
