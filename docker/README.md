...
A docker container for running Holochain and installing hApps to host them as always-on-nodes. For a Unyt specific integration with Holo Edge nodes, read instructions here
